...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center">
      ...
      <Section className="h-timing mb-0">
        ...
        >
          ...
          <Container className="h-auto pt-20 text-white">
            ...
            <div
              className="mb-4 mt-10 flex flex-col items-center justify-center"
              data-aos="flip-up"
              data-aos-duration="2000"
              data-aos-delay="100"
            >
      ...
      <Section className="w-ful pb-10 pt-10">
        <Container className="text-center text-xl not-italic">
          ...
          <div data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
            <p>По всем возникшим вопросам просьба обращаться по телефону</p>
            <a href="tel:5032478727">(503)-427-8727</a>
          </div>
        </Container>
      </Section>
    </main>
